 ...
 * - **CN:** 枚举项集合
 */
export declare class EnumCollectionClass<const T extends EnumInit<K, V>, K extends EnumKey<T> = EnumKey<T>, V extends EnumValue = ValueTypeFromSingleInit<T[K], K>, const P = any> extends EnumExtensionClass<T, K, V> implements InheritableEnumItems<T, K, V, P> {
