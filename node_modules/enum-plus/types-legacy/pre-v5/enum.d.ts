...
export interface EnumInterface {
     ...
     */
    <T extends EnumInit<K, V>, K extends EnumKey<T> = EnumKey<T>, V extends EnumValue = ValueTypeFromSingleInit<T[K], K>, P = any, OP extends EnumInitOptions<T, K, V, P> = EnumInitOptions<T, K, V, P>>(raw: T, options?: EnumInitOptions<T, K, V, P>): IEnum<T, K, V, P, OP> & NativeEnumMembers<T, K, V>;
    /**
