 ...
 */
export var ITEMS = Symbol.for('[items]');
 ...
 */
export var KEYS = Symbol.for('[keys]');
 ...
 */
export var VALUES = Symbol.for('[values]');
 ...
 */
export var LABELS = Symbol.for('[labels]');
 ...
 */
export var RAW = Symbol.for('[raw]');
export var ENUM_OPTIONS = Symbol.for('[EnumOptions]');
 ...
 */
export var META = Symbol.for('[meta]');
 ...
 */
export var defaultLocalize = function defaultLocalize(content) {
  return content;
};
